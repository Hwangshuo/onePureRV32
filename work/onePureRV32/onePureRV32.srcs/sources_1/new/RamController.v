...
module RamController (input clk,
                      ...
                      input[`RAM_WIDTH-1:0] mem_wdata_i,           //from Init
                      ...
                      input[`RAM_WIDTH-1:0] mem_wdata_init_i,      //from DEBUG
    ...
    always @ (*)
        if (!debug_rst_n_i)
        begin
            wen_o   = mem_wen_init_i;                             //to RAM
            waddr_o = mem_waddr_init_i;
            wdata_o = mem_wdata_init_i;
        end
        else begin
            case(state_i)
                `IF:begin
